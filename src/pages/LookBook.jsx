  ...
  return (
    <div className="w-full bg-white">
      <div className="w-full">
        {/* PC: 좌측 고정 리모콘 + 우측 이미지 */}
        <div className="hidden lg:grid grid-cols-[320px_minmax(0,1fr)]">
          <aside className="bg-white border-r border-black/5">
            <div className="sticky top-0 px-6 py-6 pb-8 flex flex-col">
              <p className="text-[11px] tracking-[0.12em] uppercase text-black/50 mb-4">
                LOOKBOOK
              </p>
                ...
                {teamToc.map((team) => (
                  <li key={team.name}>
                    <button
                      ...
                      className="w-full text-right text-sm py-3 px-1 text-black/75 hover:text-black transition"
                    >
                      {team.name}
                    </button>
                  </li>

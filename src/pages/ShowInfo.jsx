...
const ShowInfo = () => {
  ...
  const desktopImages = [
    { src: `${IMAGE_BASE_PATH}/팀크레딧.jpg`, alt: "팀 크레딧 데스크탑" },
    { src: `${IMAGE_BASE_PATH}/전시안내.png`, alt: "전시 안내 데스크탑" },
    { src: `${IMAGE_BASE_PATH}/오시는길.jpg`, alt: "오시는 길 데스크탑" },
  ];

  const mobileImages = [
    { src: `${IMAGE_BASE_PATH}/팀크레딧_모바일_1.jpg`, alt: "팀 크레딧 #1" },
    { src: `${IMAGE_BASE_PATH}/팀크레딧_모바일_2.jpg`, alt: "팀 크레딧 #2" },
    { src: `${IMAGE_BASE_PATH}/전시안내_모바일_1.jpg`, alt: "전시 안내 #1" },
    { src: `${IMAGE_BASE_PATH}/전시안내_모바일_2.png`, alt: "전시 안내 #2" },
    { src: `${IMAGE_BASE_PATH}/오시는길_모바일_1.jpg`, alt: "오시는 길 #1" },
    { src: `${IMAGE_BASE_PATH}/오시는길_모바일_2.jpg`, alt: "오시는 길 #2" },
  ];

  return (
    <div className="w-full bg-white py-10 md:py-14 px-4">
      {/* Main Theme */}
      <section className="w-full max-w-[1040px] mb-8 md:mb-10 mx-auto">
        <div className="border border-black/5 bg-white/90 shadow-[0_4px_14px_rgba(0,0,0,0.04)] p-5 md:p-8">
          <p className="text-[11px] md:text-xs tracking-[0.16em] text-black/55 uppercase mb-3 md:mb-4">
            Main Theme
          </p>

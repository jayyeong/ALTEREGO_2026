                                ...
                                <div className="order-2 lg:order-1 lg:w-[260px] flex-shrink-0 text-left">
                                    ...
                                    <div className="mt-2 space-y-1">
                                        {(current.captionLines || []).map((line, i) => (
                                            <p key={i} className="text-[13px] text-black leading-relaxed whitespace-pre-line">
                                                {line}
                                            </p>
                                        ))}
                                    </div>
